  ...
  return (
    <div className="flex items-center justify-center min-h-screen background-login">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8 flex flex-col items-center">
        ...
        <p className="text-gray-400 text-sm mb-6">Sign in to continue to your Digital Library</p>
        <div className="w-full">
          <label className="block text-left text-sm font-medium mb-1">Username / Email</label>
          <input
            type="text"
          ...
          <div className="flex items-center mb-4">
            <button className="ml-auto text-xs text-blue-400 hover:underline" onClick={() => onNavigate?.('forgot')}>Forgot password?</button>
          </div>
          <button
          ...
          <div className="flex justify-center text-xs mt-2">
            <span>Not a member? <button className="text-blue-400 hover:underline" onClick={() => onNavigate?.('register')}>Register Now</button></span>
          </div>
        </div>
      </div>
    </div>

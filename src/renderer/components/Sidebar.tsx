    ...
    <div className="h-full w-64 bg-white  flex flex-col justify-between ">
      <div>
        ...
        <nav className="flex-1 px-2">
          <div className="text-xs text-gray-400 uppercase mb-2 pl-2">เมนูหลัก</div>
          <ul className="space-y-1">
            ...
            <li>
              ...
              >
                <img src={hearticon} alt="ลิสต์ของฉัน" className="w-6 h-6 mr-2" />
                ลิสต์ของฉัน
              </button>
            </li>
            <li>
      ...
      <div className="px-4 pb-6 flex flex-col items-center">
        <button className="w-full flex items-center px-4 py-2 rounded hover:bg-gray-100 mt-2 text-gray-500 border-t border-gray-200 gap-2" onClick={() => onNavigate('setting')}>
          <IoSettings className="text-gray-500 w-8 h-8" /> การตั้งค่า
        </button>

        <button className="w-full flex items-center px-4 py-2 rounded hover:bg-gray-100 mt-2 text-gray-500 border-t border-gray-200 gap-2" onClick={logout}>
          <CiLogout className="text-gray-500 w-8 h-8" /> ออกจากระบบ
        </button>

        <a className='flex flex-row items-center mt-4 gap-2 cursor-pointer' onClick={() => onNavigate('profile')}>
